...
def plot_attention_overlay(similarity_np, tokens, grid_size, image, text, save_path=None):
    """Plot attention heatmaps overlaid on the original image."""
    ...
    fig.suptitle(f'Token Attention Overlays\nText: "{text}"', fontsize=16, y=0.98)
    
    # Custom colormap for attention (transparent to red)
...
def main():
    ...
    image_path = r"D:/Wajahat Ali Khan/CLIP/images/apple.png"
    image = Image.open(image_path).convert("RGB")
    text = "an image of five apples"
